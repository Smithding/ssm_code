LoginController<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
				...
				<form action="${pageContext.request.contextPath}/user/Login.action" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post">
		            ...
		            <div class="uinArea" id="uinArea">
		                ...
		                <div class="inputOuter" id="uArea">
	                    	<input type="text" id="u" name="username" class="inputstyle" /><span id="umsg"></span>
	                ...
	                <div class="pwdArea" id="pwdArea">
		               ...
		               <div class="inputOuter" id="pArea">
		                    <input type="password" id="p" name="password" class="inputstyle" /><span id="pmsg"></span>
